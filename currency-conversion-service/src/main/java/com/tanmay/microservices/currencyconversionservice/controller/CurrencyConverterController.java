package com.tanmay.microservices.currencyconversionservice.controller;
...
import com.tanmay.microservices.currencyconversionservice.proxy.CurrencyExchangeProxy;
...
public class CurrencyConverterController {
	...
	public CurrencyConversion retriveCurrencyConversionFeign(
			@PathVariable String from,@PathVariable String to,@PathVariable BigDecimal quantity) {
